...
Route::prefix('user_account_data')->group(function (): void {
    ...
    Route::get('get-name-by-credentials', [UserAccountDataController::class, 'getNameByCredentials']);
    Route::get('check-user-password/{password?}', [UserAccountDataController::class, 'checkUserPassword']);
...
// User photo (used by the topbar avatar image src)
